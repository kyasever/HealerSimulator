            ...
            try
            {
                ...
                if (paramLen == 1)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Array, null, false, false))
                    {
                        ...
                        var Arg0 = argHelper0.Get<System.Int32[]>(false);
                        obj.CopyTo(Arg0);
                ...
                if (paramLen == 4)
                {
                        ...
                        && argHelper3.IsMatch(Puerts.JsValueType.Number, null, false, false))
                    {
                        ...
                        var Arg0 = argHelper0.GetInt32(false);
                        var Arg1 = argHelper1.Get<System.Int32[]>(false);
                        var Arg2 = argHelper2.GetInt32(false);
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        Puerts.StaticTranslate<System.Int32[]>.Set((int)data, isolate, Puerts.NativeValueApi.SetValueToResult, info, result);
