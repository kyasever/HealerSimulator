...
namespace PuertsStaticWrap
{
    public static class PuertsTest_DerivedClass_Wrap
    {
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        Puerts.StaticTranslate<System.Threading.Tasks.Task<int>>.Set((int)data, isolate, Puerts.NativeValueApi.SetValueToResult, info, result);
        ...
        private static void G_DMF(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                PuertsTest.DerivedClass obj = Puerts.Utils.GetSelf((int)data, self) as PuertsTest.DerivedClass;
                var result = obj.DMF;
                Puerts.PuertsDLL.ReturnNumber(isolate, info, result);
            }
            catch (Exception e)
        ...
        private static void G_MyCallback(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                Puerts.StaticTranslate<PuertsTest.MyCallback>.Set((int)data, isolate, Puerts.NativeValueApi.SetValueToResult, info, result);
            }
            catch (Exception e)
            {
                Puerts.PuertsDLL.ThrowException(isolate, "c# exception:" + e.Message + ",stack:" + e.StackTrace);
