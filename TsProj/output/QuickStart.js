...
// 使用yarn build 编译js并输出到平台
const csharp_1 = require("csharp");
const puerts_1 = require("puerts");
// 增加自己的类之后, 需要在cs代码中注册一下,然后才能点导出
let myClass = new csharp_1.PuertsTest.MyClass();
//静态函数
...
/*async function asyncCall() {
    ...
    let task2 = obj.GetFileLength("unNameFile");//这个会抛文件找不到异常，被catch
